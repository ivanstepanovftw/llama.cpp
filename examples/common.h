...
struct gpt_params {
    ...
    int32_t n_keep        = 0;    // number of tokens to keep from initial prompt (-1 = keep whole prompt)
    ...
    float   temp              = 1.00f; // 1.0 = disabled
    float   repeat_penalty    = 1.00f; // 1.0 = disabled
    int32_t repeat_last_n     = 0;     // last n tokens to penalize (0 = disable penalty, -1 = context size)
